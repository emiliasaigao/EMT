...
namespace esgstl {
	...
	template<class T>
	inline typename list<T>::iterator list<T>::fill_insert(const_iterator pos, size_type n, const value_type& value) {
		list tmp(n, value);
	...
	template<class T>
	inline typename list<T>::iterator list<T>::link_iter_node(const_iterator iter, base_ptr node) {
	...
	template<class T>
	inline typename list<T>::iterator list<T>::erase(const_iterator pos) {
	...
	template<class T>
	inline typename list<T>::iterator list<T>::erase(const_iterator first, const_iterator last) {
		if (first != last) {
			auto b = first.node_;
			auto e = last.node_;
