...
namespace esgstl {
	...
	struct hashtable_iterator {
		...
		iterator& operator=(hashtable_iterator&& rhs) noexcept{
			if (this != &rhs) {
				cur = rhs.cur;
				ht = rhs.ht;
				rhs.cur = nullptr;
...
#define PRIME_NUM 44
	...
	template<class Value, class Key, class HashFcn, class ExtractKey, class EqualKey>
	inline typename hashtable<Value, Key, HashFcn, ExtractKey, EqualKey>::iterator
	hashtable<Value, Key, HashFcn, ExtractKey, EqualKey>::
	...
	template<class Value, class Key, class HashFcn, class ExtractKey, class EqualKey>
	inline typename hashtable<Value, Key, HashFcn, ExtractKey, EqualKey>::size_type
	hashtable<Value, Key, HashFcn, ExtractKey, EqualKey>::
	...
	template<class Value, class Key, class HashFcn, class ExtractKey, class EqualKey>
	inline typename hashtable<Value, Key, HashFcn, ExtractKey, EqualKey>::const_iterator
	...
	template<class Value, class Key, class HashFcn, class ExtractKey, class EqualKey>
	template<class ...Args>
	inline typename hashtable<Value, Key, HashFcn, ExtractKey, EqualKey>::node_ptr
	hashtable<Value, Key, HashFcn, ExtractKey, EqualKey>::
